...
- **Allontanamento volatili** con sistemi disabituanti;
- **igienizzazione e neutralizzazione degli odori** degli ambienti trattati;
- piani di **prevenzione programmata** (pest control) con passaggi periodici e reportistica.

![Squadra di disinfestazione al lavoro](img/squadra-disinfestazione.jpg)

## Come lavoriamo

1. **Sopralluogo** e identificazione dell'infestante;
2. **trattamento mirato** con prodotti professionali certificati;
3. **verifica e monitoraggio** nel tempo, con interventi di richiamo se necessari.
